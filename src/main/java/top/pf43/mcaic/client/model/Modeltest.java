package top.pf43.mcaic.client.model;
...
public class Modeltest<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcaic", "modeltest"), "main");
